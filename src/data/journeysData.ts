    ...
    isComingSoon: false,
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'prn-2-8', subgroup: 'Explorando o mundo através do brincar', title: 'Brincar é fundamental: o desenvolvimento também acontece na diversão', duration: '- min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788438908723-c1641110.jpg', description: 'Entenda por que brincar é essencial e como aproveitar melhor esses momentos.', xpPoints: 0 },
    ...
    isComingSoon: true,
        modules: [
      {
        ...
        lessons: [
          ...
          { id: 'cp-1-6', subgroup: 'O Lado de Cá: Redescobrindo Quem Você É', title: 'Celebrando a jornada: reconheça o caminho que vocês já percorreram', duration: '- min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788446309873-a4d689cb.jpg', description: 'Valorize conquistas e aprendizados sem perder de vista o que ainda vem.', xpPoints: 0 },
          ...
          { id: 'cp-1-18', subgroup: 'O Lado de Lá: O Mundo Digital', title: 'Limites para telas: acordos claros sem transformar a casa em guerra', duration: '- min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788446512172-528058ab.jpg', description: 'Crie limites possíveis para telas, com menos punição e mais clareza.', xpPoints: 0 }
        ]
      },
      {
        id: 'cp-mod-2',
        ...
        lessons: [
          ...
          { id: 'cp-2-30', subgroup: 'Autonomia e Responsabilidade', title: 'Consequências naturais e lógicas: deixando a vida também ensinar', duration: '21 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', description: 'Use consequências para ensinar responsabilidade sem transformar tudo em punição.', xpPoints: 50 },
    ...
    isComingSoon: true,
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'sing-2-2', subgroup: 'Além do Diagnóstico', title: 'As diferenças e o ritmo único do desenvolvimento', duration: '18 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788529430503-7b142fbe.jpg', description: 'O encontro de paz e respeito para acompanhar o tempo próprio da sua criança.', xpPoints: 0 },
...

  {
    ...
    isComingSoon: true,
        modules: [
      {
        id: 'ae-mod-1',
        number: 1, 
        title: 'A Espera e o Encontro',
        lessons: [
          { id: 'ae-1-1', subgroup: 'A Gestação Invisível', title: 'Antes do sim: o desejo, os medos e o chamado', duration: '19 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788535762597-e3534c6b.jpg', description: 'Um espaço para entender as incertezas e a força que iniciam a adoção.', xpPoints: 0 },
          { id: 'ae-1-2', subgroup: 'A Gestação Invisível', title: 'A espera e a relação: o tempo testa o amor', duration: '21 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788535814259-43aee260.jpg', description: 'O fortalecimento do casal enquanto o momento do grande encontro não chega.', xpPoints: 0 },
          { id: 'ae-1-3', subgroup: 'A Gestação Invisível', title: 'Expectativas invisíveis: imaginado e possível', duration: '20 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788535865152-6a033421.jpg', description: 'A passagem do cenário idealizado para a aceitação amorosa da realidade.', xpPoints: 0 },
          { id: 'ae-1-4', subgroup: 'A Chegada', title: 'O primeiro olhar: quando as histórias se cruzam', duration: '16 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/SubaruOutbackBranding.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788535848416-ec43d95b.jpg', description: 'A emoção e a delicadeza dos primeiros contatos reais com a sua criança.', xpPoints: 0 },
          { id: 'ae-1-5', subgroup: 'A Chegada', title: 'Puerpério da adoção e conexões com os irmãos', duration: '16 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoylikes.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788538037956-27e79b7a.jpg', description: 'A reorganização da casa e o cultivo de laços seguros entre os filhos.', xpPoints: 0 },
          { id: 'ae-1-6', subgroup: 'A Chegada', title: 'Máscara de oxigênio: o cuidado com quem cuida', duration: '21 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788538063508-ae0b61be.jpg', description: 'A busca por respiros para aliviar o peso e sustentar a transição de todos.', xpPoints: 0 }
        ]
      },
      {
        id: 'ae-mod-2',
        number: 2, 
        title: 'O Nascer dos Laços',
        lessons: [
          { id: 'ae-2-1', subgroup: 'O Tempo da Adaptação', title: 'Adaptação da criança: luto e testes de amor', duration: '20 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788537949121-863b35d8.jpg', description: 'Um olhar empático sobre o medo da perda e a necessidade de segurança.', xpPoints: 0 },
          { id: 'ae-2-2', subgroup: 'O Tempo da Adaptação', title: 'O tempo do corpo: afeto físico e seus limites', duration: '19 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788538000238-425fdb90.jpg', description: 'O respeito pelo espaço da criança até que o abraço se torne um porto seguro.', xpPoints: 0 },
          { id: 'ae-2-3', subgroup: 'O Tempo da Adaptação', title: 'O cultivo do vínculo: o amor que nasce na ação', duration: '18 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/WhatCarCanYouGetForAGrand.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788535900885-03ff0755.jpg', description: 'A descoberta de que o afeto ganha raízes através do cuidado do dia a dia.', xpPoints: 0 },
          { id: 'ae-2-4', subgroup: 'A História e a Verdade', title: 'Falando de origem: respeito, verdade e linguagem', duration: '15 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/SubaruOutbackBranding.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788538137404-debf4367.jpg', description: 'Caminhos leves e honestos para conversar sobre o passado em cada idade.', xpPoints: 0 },
          { id: 'ae-2-5', subgroup: 'A História e a Verdade', title: 'Quando as perguntas doem: a família biológica', duration: '22 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/WeAreGoingOnBullrun.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788541941863-3a268b9d.jpg', description: 'O acolhimento das dúvidas difíceis com serenidade, presença e muito amor.', xpPoints: 0 },
          { id: 'ae-2-6', subgroup: 'A História e a Verdade', title: 'Ajudando a criança a pertencer à nova família', duration: '20 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788538154823-295c6cce.jpg', description: 'O despertar do sentimento profundo de pertencer e ter um lugar no mundo.', xpPoints: 0 }
        ]
      },
      {
        id: 'ae-mod-3',
        number: 3, 
        title: 'A Vida que se Constrói',
        lessons: [
          { id: 'ae-3-1', subgroup: 'A Casa e o Mundo', title: 'Rotinas que fortalecem: a casa como lugar seguro', duration: '20 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/WhatCarCanYouGetForAGrand.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788541967620-1147619b.jpg', description: 'A mágica dos rituais diários e da previsibilidade para acalmar corações.', xpPoints: 0 },
          { id: 'ae-3-2', subgroup: 'A Casa e o Mundo', title: 'Lidando com o mundo: acolhendo olhares curiosos', duration: '18 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788541986651-c4d7bf95.jpg', description: 'Formas seguras de lidar com palpites externos e proteger a intimidade.', xpPoints: 0 },
          { id: 'ae-3-3', subgroup: 'A Casa e o Mundo', title: 'O amor que advoga: a escola e o pertencimento', duration: '17 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788542044255-74cd4b6a.jpg', description: 'O apoio amoroso na preparação da escola para abraçar a história do seu filho.', xpPoints: 0 },
          { id: 'ae-3-4', subgroup: 'Rede e Celebração', title: 'Formando a sua rede: o poder do apoio que atua', duration: '16 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788542061109-17bb4ce1.jpg', description: 'A união de um círculo de amigos e parentes para dar suporte verdadeiro.', xpPoints: 0 },
          { id: 'ae-3-5', subgroup: 'Rede e Celebração', title: 'Celebrando a jornada: honrando a história de vocês', duration: '20 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoylikes.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788542099704-7a7df0af.jpg', description: 'A alegria de comemorar a vida e a união que vocês decidiram trilhar juntos.', xpPoints: 0 }
        ]
      }
    ]
  },

  {
    ...
    isComingSoon: true,
        modules: [
      {
        id: 'nc-mod-1',
        number: 1, 
        title: 'O Silêncio que Muda Tudo',
        lessons: [
          { id: 'nc-1-1', subgroup: 'A Nova Dinâmica', title: 'A casa que ficou maior: o choque do silêncio', duration: '18 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/SubaruOutbackBranding.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788545722137-7756f700.jpg', description: 'O entendimento da solidão inicial e a adaptação à nova paz do ambiente.', xpPoints: 0 },
          { id: 'nc-1-2', subgroup: 'A Nova Dinâmica', title: 'O fechamento de um ciclo: a saudade e o luto', duration: '19 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788545705353-8d070b4a.jpg', description: 'Um espaço para vivenciar a nostalgia de uma longa fase que se encerra.', xpPoints: 0 },
          { id: 'nc-1-3', subgroup: 'A Nova Identidade', title: 'A identidade em transição: quem sou eu agora?', duration: '20 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788545740476-0bf170ad.jpg', description: 'A reflexão sobre o papel de mãe e pai quando o cuidado diário muda.', xpPoints: 0 },
          { id: 'nc-1-4', subgroup: 'A Nova Identidade', title: 'O tempo e o espaço: lidando com o quarto vazio', duration: '16 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/WeAreGoingOnBullrun.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788545758066-88000490.jpg', description: 'A ressignificação das horas livres e dos cantos da casa sem uso.', xpPoints: 0 }
        ]
      },
      {
        id: 'nc-mod-2',
        number: 2, 
        title: 'O Tempo de Reencontros',
        lessons: [
          { id: 'nc-2-1', subgroup: 'O Resgate Individual', title: 'O despertar interior: redescobrindo os desejos', duration: '15 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/WhatCarCanYouGetForAGrand.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788545783658-da353483.jpg', description: 'O resgate suave de vontades hábitos e interesses antigos esquecidos.', xpPoints: 0 },
          { id: 'nc-2-2', subgroup: 'O Resgate Individual', title: 'O resgate de sonhos: buscando novos horizontes', duration: '18 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788545798918-7d2deeac.jpg', description: 'A motivação para olhar o futuro e tirar projetos pessoais do papel.', xpPoints: 0 },
          { id: 'nc-2-3', subgroup: 'A Redescoberta a Dois', title: 'Somos só nós dois: a redescoberta da parceria', duration: '21 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788545817227-547a683a.jpg', description: 'O ajuste da dinâmica do casal para viver essa nova fase com leveza.', xpPoints: 0 },
          { id: 'nc-2-4', subgroup: 'A Redescoberta a Dois', title: 'A conversa além dos filhos: resgatando assuntos', duration: '16 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4', description: 'O desafio de voltar a falar sobre vocês mesmos e achar afinidades.', xpPoints: 0 },
          { id: 'nc-2-5', subgroup: 'A Redescoberta a Dois', title: 'A nova intimidade: criando planos a dois', duration: '20 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4', description: 'A construção de novos projetos para fortalecer a parceria amorosa.', xpPoints: 0 }
        ]
      },
      {
        id: 'nc-mod-3',
        ...
        lessons: [
          { id: 'nc-3-1', subgroup: 'A Relação Adulta', title: 'A arte de estar presente: o apoio sem invasão', duration: '22 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4', description: 'O equilíbrio entre oferecer suporte e respeitar o espaço do filho.', xpPoints: 0 },
          { id: 'nc-3-2', subgroup: 'A Relação Adulta', title: 'A comunicação que aproxima: amor à distância', duration: '20 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/WhatCarCanYouGetForAGrand.mp4', description: 'A criação de novos rituais e linguagens para manter o afeto vivo.', xpPoints: 0 },
          { id: 'nc-3-3', subgroup: 'A Família Expandida', title: 'Efeito bumerangue: quando o filho adulto volta', duration: '18 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', description: 'A nova convivência sem que ele volte a ser tratado como adolescente.', xpPoints: 0 },
          { id: 'nc-3-4', subgroup: 'A Família Expandida', title: 'A família cresce: novos laços e a vida de avós', duration: '17 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4', description: 'A arte de acolher a nova família do filho respeitando os seus espaços.', xpPoints: 0 },
          { id: 'nc-3-5', subgroup: 'A Celebração da Vida', title: 'De cuidador a mentor: o seu novo papel na vida', duration: '19 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', description: 'A compreensão dessa transição natural de quem cuida para quem apoia.', xpPoints: 0 },
          { id: 'nc-3-6', subgroup: 'A Celebração da Vida', title: 'Celebrando os voos: a alegria do caminho livre', duration: '22 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4', description: 'A comemoração da independência dos filhos e da sua própria liberdade.', xpPoints: 0 }
        ]
      }
    ]
  },
    ...
    isEnabled: false,
        modules: [
      {
        ...
        lessons: [
          ...
          { id: 'dds-1-4', subgroup: 'Corpo', title: 'Quando o corpo também carrega o peso do luto', duration: '16 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', description: 'Perceba como sono, energia, atenção e disposição podem mudar sem cobrar de si um retorno rápido à normalidade.', xpPoints: 0 },
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'dds-2-5', subgroup: 'Mundo ao redor', title: 'Quando você não sabe o que responder - e os outros não sabem o que dizer', duration: '16 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', description: 'Crie palavras e limites para perguntas, comentários e situações que exigem de você mais do que consegue oferecer.', xpPoints: 0 },
