...

  {
    ...
    isComingSoon: true,
        modules: [
      {
        id: 'ae-mod-1',
        number: 1, 
        title: 'O Caminho Até o Encontro',
        lessons: [
          { id: 'ae-1-1', subgroup: 'A Espera e o Desejo', title: 'Antes do sim: o desejo os medos e o chamado', duration: '19 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788535762597-e3534c6b.jpg', description: 'Um espaço para entender as incertezas e a força que iniciam a adoção.', xpPoints: 0 },
          { id: 'ae-1-2', subgroup: 'A Espera e o Desejo', title: 'A espera e a relação: como o tempo testa o amor', duration: '21 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788535814259-43aee260.jpg', description: 'O fortalecimento do casal enquanto o momento do grande encontro não chega.', xpPoints: 0 },
          { id: 'ae-1-3', subgroup: 'A Espera e o Desejo', title: 'Expectativas invisíveis: o imaginado e o possível', duration: '20 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788535865152-6a033421.jpg', description: 'A passagem do cenário idealizado para a aceitação da realidade como ela é.', xpPoints: 0 }
        ]
      },
      {
        id: 'ae-mod-2',
        number: 2, 
        title: 'Quando o Encontro Acontece',
        lessons: [
          { id: 'ae-2-1', subgroup: 'Os Primeiros Passos', title: 'O primeiro olhar: quando duas histórias se cruzam', duration: '16 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/SubaruOutbackBranding.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788535848416-ec43d95b.jpg', description: 'A emoção e a delicadeza dos primeiros contatos reais com a sua criança.', xpPoints: 0 },
          { id: 'ae-2-2', subgroup: 'Os Primeiros Passos', title: 'Construção do vínculo: o amor que nasce nas ações', duration: '18 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/WhatCarCanYouGetForAGrand.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788535900885-03ff0755.jpg', description: 'A descoberta de que o afeto ganha raízes através do cuidado do dia a dia.', xpPoints: 0 },
          { id: 'ae-2-3', subgroup: 'Adaptação e Cuidado', title: 'Adaptação da criança: o luto e os testes de amor', duration: '20 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788537949121-863b35d8.jpg', description: 'Um olhar empático sobre o medo da perda e a necessidade de sentir segurança.', xpPoints: 0 },
          { id: 'ae-2-4', subgroup: 'Adaptação e Cuidado', title: 'O tempo do corpo: o afeto físico e os seus limites', duration: '19 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788538000238-425fdb90.jpg', description: 'O respeito pelo espaço da criança até que o abraço se torne um porto seguro.', xpPoints: 0 },
          { id: 'ae-2-5', subgroup: 'Adaptação e Cuidado', title: 'O puerpério da adoção e as conexões com os irmãos', duration: '16 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoylikes.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788538037956-27e79b7a.jpg', description: 'A reorganização da casa e a construção de laços seguros entre os filhos.', xpPoints: 0 },
          { id: 'ae-2-6', subgroup: 'Adaptação e Cuidado', title: 'A máscara de oxigênio: o autocuidado nessa fase', duration: '21 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788538063508-ae0b61be.jpg', description: 'A busca por respiros para aliviar o medo de falhar e sustentar a transição.', xpPoints: 0 }
        ]
      },
      {
        id: 'ae-mod-3',
        number: 3, 
        title: 'A Origem, os Laços e a Verdade',
        lessons: [
          { id: 'ae-3-1', subgroup: 'Falando da História', title: 'Como falar de origem: respeito, verdade e linguagem', duration: '15 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/SubaruOutbackBranding.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788538137404-debf4367.jpg', description: 'Caminhos leves e honestos para conversar sobre o passado em cada idade.', xpPoints: 0 },
          { id: 'ae-3-2', subgroup: 'Falando da História', title: 'Ajudando a criança a se reconhecer na nova família', duration: '20 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788538154823-295c6cce.jpg', description: 'A construção do sentimento profundo de pertencer e ter um lugar no mundo.', xpPoints: 0 },
          { id: 'ae-3-3', subgroup: 'Falando da História', title: 'Quando perguntas doem: família biológica e abandono', duration: '22 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/WeAreGoingOnBullrun.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788541941863-3a268b9d.jpg', description: 'O acolhimento das dúvidas difíceis com serenidade presença e muito amor.', xpPoints: 0 }
        ]
      },
      {
        id: 'ae-mod-4',
        ...
        lessons: [
          { id: 'ae-4-1', subgroup: 'Rotina e Sociedade', title: 'Rotinas que fortalecem: a casa como lugar seguro', duration: '20 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/WhatCarCanYouGetForAGrand.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788541967620-1147619b.jpg', description: 'A mágica dos rituais diários e da previsibilidade para acalmar os corações.', xpPoints: 0 },
          { id: 'ae-4-2', subgroup: 'Rotina e Sociedade', title: 'Lidando com o mundo: acolhendo os olhares curiosos', duration: '18 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788541986651-c4d7bf95.jpg', description: 'Formas seguras de lidar com palpites externos e proteger a sua intimidade.', xpPoints: 0 },
          { id: 'ae-4-3', subgroup: 'Rotina e Sociedade', title: 'O amor que advoga: a escola e o pertencimento', duration: '17 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788542044255-74cd4b6a.jpg', description: 'O apoio na preparação da escola para abraçar a história do seu filho.', xpPoints: 0 },
          { id: 'ae-4-4', subgroup: 'Rotina e Sociedade', title: 'Formando a sua rede: o poder do apoio que funciona', duration: '16 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788542061109-17bb4ce1.jpg', description: 'A criação de um círculo de amigos e parentes para dar suporte verdadeiro.', xpPoints: 0 },
          { id: 'ae-4-5', subgroup: 'Celebração do Amor', title: 'Celebrando a jornada: honrando a história de vocês', duration: '20 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoylikes.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788542099704-7a7df0af.jpg', description: 'A alegria de comemorar a vida e a união que vocês decidiram trilhar juntos.', xpPoints: 0 }
        ]
      }
    ]
  },
