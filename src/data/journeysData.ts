...

  {
    ...
    isComingSoon: true,
      ...
      },
      {
        ...
        lessons: [
          { id: 'ae-2-1', subgroup: 'O Tempo da Adaptação', title: 'Adaptação da criança: luto e testes de amor', duration: '20 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788537949121-863b35d8.jpg', description: 'Um olhar empático sobre o medo da perda e a necessidade de segurança.', xpPoints: 0 },
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'ae-3-2', subgroup: 'A Casa e o Mundo', title: 'Lidando com o mundo: acolhendo olhares curiosos', duration: '18 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788541986651-c4d7bf95.jpg', description: 'Formas seguras de lidar com palpites externos e proteger a intimidade.', xpPoints: 0 },
    ...
    isComingSoon: true,
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'nc-2-2', subgroup: 'O Resgate Individual', title: 'O resgate de sonhos: buscando novos horizontes', duration: '18 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4', thumbnailUrl: 'https://mixedzmkjfzumeimfkfz.supabase.co/storage/v1/object/public/user-media/community/1788545798918-7d2deeac.jpg', description: 'A motivação para olhar o futuro e tirar projetos pessoais do papel.', xpPoints: 0 },
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'nc-3-3', subgroup: 'A Família Expandida', title: 'Efeito bumerangue: quando o filho adulto volta', duration: '18 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4', description: 'A nova convivência sem que ele volte a ser tratado como adolescente.', xpPoints: 0 },
