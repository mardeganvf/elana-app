    ...
    modules: [
      {
        ...
        lessons: [
          ...
          { id: 'prn-1-1', title: 'Uma Nova Identidade: Quem sou eu agora?', duration: '14 min', videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4', description: 'Como conciliar a vida pessoal, profissional e a chegada do bebê.', xpPoints: 50 },
