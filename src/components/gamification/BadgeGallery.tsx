...
export const getHowToUnlock = (badge: Badge): string => {
  const instructions: Record<string, string> = {
    ...
    b59: 'Escreva e salve reflexões pessoais em 5 conteúdos diferentes.',
    b60: 'Escreva e salve reflexões pessoais em 10 conteúdos diferentes.',
    b61: 'Escreva e salve reflexões pessoais em 15 conteúdos diferentes.',
