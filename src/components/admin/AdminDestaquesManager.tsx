...
export const AdminDestaquesManager: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {destaques.length === 0 && (
        <div className="text-center py-16 bg-[#101B1E] rounded-3xl border border-white/10 space-y-3">
          <Sparkles className="w-10 h-10 text-slate-500 mx-auto" />
          <h3 className="text-base font-bold text-white">Nenhum destaque cadastrado</h3>
          <p className="text-xs text-slate-400 max-w-md mx-auto">
            Clique no botão acima para cadastrar seu primeiro vídeo de destaque para a página inicial.
          </p>
          <button
            type="button"
            onClick={openNewModal}
            className="px-4 py-2 bg-[#FF7F5B] text-slate-950 font-black rounded-xl text-xs inline-flex items-center gap-2"
          >
            <Plus className="w-4 h-4 stroke-[3]" />
